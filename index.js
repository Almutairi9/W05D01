...
// app.delete("/remove/color",(request,response) =>{
//     const {color} = request.body
//     students.splice(students.indexOf({color}), 1);
//     response.status(200); 
//     response.json(color); 
// });

// // app.put("/name",  (request, response) =>{
// //    const addWord= (request.body.word, request.body.definition)
// //     .then( (resp)=> {
// //         response.send(resp);
// //       })
// //       .catch(function (students) {
// //         console.log(students); 
// //         response.status(500).send(students);
// //       });
// //   }); 
